...
*/
//========================================================================
public class NumericFloatTextFieldWithLimit extends TextFieldWithLimit
{
	Float minInclusive=null;
	Float maxInclusive=null;

//========================================================================
	public NumericFloatTextFieldWithLimit (String initialStr, int col, int maxLength) 
	{
...
//========================================================================
	...
	public boolean disallowedChar(char c)
	{
		...
		//allow digits and max one decimal separator '.'
		return (!Character.isDigit(c) && c!='.' || (c=='.' && getText().contains(".")) );
	}

//========================================================================
	public float getNumericStep(KeyEvent e)
	{
